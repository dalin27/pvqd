...
ax[0].errorbar(data['times'][:40], data['Sx_0'][:40], yerr=data['err_Sx_0'][:40], label="pVQD", marker='o',
               linestyle='', elinewidth=1, color='C0', capsize=2, markersize=3.5)
...
ax[1].errorbar(data['times'][:40], data['Sz_0'][:40], yerr=data['err_Sz_0'][:40], label="pVQD", marker='o',
               linestyle='', elinewidth=1, color='C0', capsize=2, markersize=3.5)
