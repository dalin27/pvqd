...
#----------------------------------------------------------------------------------------------------#
# Choose system parameters for Ising
...
shots = 800  # number of times to execute Qiskit circuit
...
if shots > 1:
	...
	out_filename = 'data/tfim_nspins={}_j={}_h={}_shots={}.json'.format(num_qubits,coup,field,shots)
elif shots == 1:
	backend = Aer.get_backend('statevector_simulator')
	out_filename = 'data/tfim_nspins={}_j={}_h={}_statevec.json'.format(num_qubits,coup,field)
